        ...
        <div class="layout-container">
            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4">Tăng like bài viết Instagram</h4>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card mb-4 card-tab">
                                <div class="card-header">
                                    <div class="row">
                                        ...
                                        <div class="col-6 d-grid gap-2">
                                            <a href="/dich-vu/instagram/like/list"
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 mb-3">
                                            ...
                                            <div class="card-body">
                                                <form submit-ajax="LTT" action="<?= BASE_URL('api/instagram/buy'); ?>"
                                                    ...
                                                    <div class="form-group row mb-3">
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            <div class="alert bg-danger text-white" role="alert">
                                                                ...
                                                                <br />
                                                                - <b>Tài khoản cần phải tắt chế độ riêng tư, nghiêm cấm
                                                                    đổi Username trong quá trình tăng, cố tình đổi
                                                                    Username không hỗ trợ</b>.
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row mb-3">
