        ...
        <div class="layout-container">
            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4">Tăng comment sale Facebook</h4>
                    <div class="row">
                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-8 mb-3">
                                            <form submit-ajax="LTT" action="<?= BASE_URL('api/facebook/buy'); ?>"
                                                ...
                                                <div class="form-group row mb-3">
                                                    <?php if ($action == "cmt") { ?><label for=""
                                                        class="form-label col-md-3">ID bài viết
                                                    </label><?php } else { ?><label for=""
                                                        class="form-label col-md-3">Link bài viết </label><?php } ?>
                                                    <div class="col-md-9">
                                                        <input class="form-control" name="id"
                                                            <?php if ($action == "cmt") { ?>placeholder="Nhập id bài viết hoặc nhập link"
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <div class="alert bg-danger text-white" role="alert">
                                                            ...
                                                            - <b>Tăng bài viết của group thì group phải công khai và
                                                                object_id phải là dạng
                                                                idgroup_idpost, ví dụ: 53489350092255_53684602739369
                                                                (chỉ hỗ trợ cho sv1, sv2)</b>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
