                                ...
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-6 d-grid gap-2">
                                            <a href="/dich-vu/facebook/mat-live" class="btn btn-primary"><img
                                                    src="https://subgiare.vn/assets/images/svg/order.svg" alt=""
                                                    width="25" height="25">
                                                Thêm đơn</a>
                                        </div>
                                        <div class="col-6 d-grid gap-2">
                                            <a href="/dich-vu/facebook/mat-live/list"
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-8 mb-3">
                                            ...
                                            <form submit-ajax="LTT" action="<?= BASE_URL('api/facebook/buy'); ?>"
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input class="form-control" name="id"
                                                            placeholder="Nhập id hoặc nhập link bài viết hệ thống tự get id"
                                                            onchange="getUID('id');" onchange="bill();">
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control mb-3" name="time_buy"
                                                            onkeyup="bill();" value="50"
                                                            placeholder="Nhập số phút cần tăng">
                                                        <div class="alert text-white bg-info text-center" role="alert">
                                                            <strong>Tổng tiền = (Số lượng) x (Số phút) x (Giá 1
                                                                mắt)</strong>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <div class="alert bg-danger text-white" role="alert">
                                                            ...
                                                            - <b>Không hỗ trợ bài viết trong nhóm, không chạy livestream
                                                                chia sẻ âm nhạc</b>.
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <?php
                                            if ($LTT->modal("mat_live", 'status') == "ON") { ?>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="modalSystemLabel">Thông báo dịch vụ</h5>
                                                            <button type="button" class="btn-close"
                                                                data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body">

                                                            <p><?= $LTT->modal('mat_live', 'text_thong_bao'); ?></p>
                                                        </div>
