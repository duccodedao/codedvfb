        ...
        <div class="layout-container">
            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4">Tăng like page quality Facebook</h4>
                    <div class="row">
                        <div class="col-md-12">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 mb-3">
                                            ...
                                            <form submit-ajax="LTT" action="<?= BASE_URL('api/facebook/buy'); ?>"
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input class="form-control" name="id"
                                                            placeholder="Nhập id hoặc nhập link page hệ thống tự get id"
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-9">
                                                        <?php $i= 1; foreach ($getrate as $showrate) { ?>
                                                        <div class="mb-2">
                                                            <div class="mb-1">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <?php
                                            if ($LTT->modal("like_page_sale", 'status') == "ON") { ?>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-body">
                                                            ...
                                                            <br>
                                                            <p class="text-center">
                                                                <?= $LTT->modal("like_page_sale", 'text_thong_bao'); ?></p>
                                                            <br>
                                                            <div class="d-grid gap-2">
