        ...
        <div class="layout-container">
            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4">Tăng sub vip Facebook</h4>
                    <div class="row">
                        <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-6 d-grid gap-2">
                                            <a href="<?= $text; ?>" class="btn btn-primary">
                                                <img src="https://subgiare.vn/assets/images/svg/order.svg" alt=""
                                                    width="25" height="25">Thêm đơn</a>
                                        </div>
                                        <div class="col-6 d-grid gap-2">
                                            <a href="<?= $text; ?>/list" class="btn btn-outline-primary">
                                                <img src="https://subgiare.vn/assets/images/svg/list-order.svg" alt=""
                                                    width="25" height="25">Danh sách đơn</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input class="form-control" name="id"
                                                            placeholder="Nhập id hoặc nhập link profile"
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <?php
                                            if ($LTT->modal("sub_sale", 'status') == "ON") { ?>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-body">
                                                            ...
                                                            <br>
                                                            <p class="text-center">
                                                                <?= $LTT->modal("sub_sale", 'text_thong_bao'); ?></p>
                                                            <br>
                                                            <div class="d-grid gap-2">
