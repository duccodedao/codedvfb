...
$dtb = "like_cmt";
$action = "like-cmt";
$title = "Cảm Xúc Comment"; ?><?php require('../../config/head.php');
        ...
        <div class="layout-container">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4">Tăng like comment Facebook</h4>
                    <div class="row">
                        <div class="col-md-12">
                                ...
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-6 d-grid gap-2">
                                            <a href="<?= $text; ?>" class="btn btn-primary">
                                            <img src="https://subgiare.vn/assets/images/svg/order.svg" alt="" width="25" height="25">Thêm đơn</a>
                                        </div>
                                        <div class="col-6 d-grid gap-2">
                                            <a href="<?= $text; ?>/list" class="btn btn-outline-primary">
                                            <img src="https://subgiare.vn/assets/images/svg/list-order.svg" alt="" width="25" height="25">Danh sách đơn</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-8 mb-3">
                                            <form submit-ajax="LTT" action="<?= BASE_URL('api/facebook/buy'); ?>" method="post" api_token="<?= $LTT->getUsers('token'); ?>">
                                                        ...
                                                        <div class="mb-2">
                                                            <div class="mb-1">
                                                                <div class="form-check">
                                                                    ...
                                                                    <label class="form-check-label" for="<?= $showrate['server_service'] ?>">SV<?= $showrate['server_service'] ?> &nbsp;(<?= $showrate['title_service'] ?>)&nbsp;
                                                                    <span class="badge bg-success text-white "><?= $showrate['rate_service'] + ($showrate['rate_service'] * $chietkhau / 100) ?> đ / lượt</span>&nbsp;<b class="text-warning">(Hoạt đông)</b></label>
                                                                </div>
                                                            </div>
                                                        </div> <?php } ?>
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <div class="alert text-white bg-info text-center" role="alert"> <strong>Tổng tiền = (Số lượng) x (Giá 1 lượt)</strong></div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <div class="mb-1">
                                                                <div class="form-check"><input class="form-check-input"
                                                                        ...
                                                                        for="speed2">Chậm (nên chọn cho ổn định,
                                                                        sẽ không
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <div class="alert bg-danger text-white" role="alert">
                                                            ...
                                                            - <b>Mua bằng ID bình luận đã mở chế độ công khai, có nút
                                                                like.</b>
                                                        </div>
                                                    </div>
                                                </div>
