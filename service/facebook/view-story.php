        ...
        <?php require_once("../../config/nav.php")?>
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4">Tăng view story Facebook</h4>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card mb-4 card-tab">
                                <div class="card-header">
                                    <div class="row">
                                        ...
                                        <div class="col-6 d-grid gap-2">
                                            <a href="/dich-vu/facebook/view-story/list"
                                ...
                                <button type="submit" class="btn btn-primary" id="buy" order="Bạn có muốn thanh toán đơn hàng?, chúng tôi sẽ không hoàn tiền với đơn đã thanh toán."><img src="/assets1/images/buy.svg" alt="" width="30" height="30"> Thanh
                                    toán</button>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <?php
                                            if ($LTT->modal("view_story", 'status') == "ON") { ?>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-body">
                                                            ...
                                                            <br>
                                                            <p class="text-center">
                                                                <?= $LTT->modal("view_story", 'text_thong_bao'); ?></p>
                                                            <br>
                                                            <div class="d-grid gap-2">
