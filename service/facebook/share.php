    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="fw-bold py-3 mb-4">Share profile Facebook</h4>
                <div class="row">
                    <div class="col-md-12">
                        <div class="card mb-4 card-tab">
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-grid gap-2">
                                        <a href="/share/list"
                                            class="btn btn-outline-primary"><img src="https://subgiare.vn/assets/images/svg/list-order.svg"
                                            ...
                                            <div class="form-group row mb-3">
                                                ...
                                                <div class="col-md-9">
                                                    <input class="form-control" name="id"
                                                        placeholder="Nhập id bài viết hoặc link"
                                                        onchange="getUID('id');">
                                                        ...
                                                        <div class="mb-1">
                                                            <div class="form-check">
                                                                <input class="form-check-input"
                                                                    id="<?= $showrate['server_service'] ?>" type="radio"
                                            ...
                                            <div class="form-group row mb-3">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <div class="alert bg-danger text-white" role="alert">
                                                        <h4>Vui lòng đọc tránh mất tiền</h4>- <b>Mua bằng ID Page đã mở
                                                            chế độ công khai, có nút like</b>.<br>- <b>Không hỗ trợ tăng
                                                            cho pro5, cố tính tăng sẽ không hỗ trợ</b>.
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row mb-3">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-body">
                                                    ...
                                                    <br>
                                                    <p class="text-center">
                                                        <?= $LTT->modal("share", 'text_thong_bao'); ?></p>
                                                    <br>
                                                    <div class="d-grid gap-2">
