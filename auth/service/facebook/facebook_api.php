...
");
    ...
    if ($action == "mem-group") {
        ...
        $code_dich_vu = "like_post";
    } elseif ($action == "like-post-sale") {
        $code_dich_vu = "like_post_sale";
    } elseif ($action == "cx-post") {
        $code_dich_vu = "cx_post";
    } elseif ($action == "sub-sale") {
        $code_dich_vu = "sub_sale";
    } elseif ($action == "sub-speed") {
        $code_dich_vu = "sub_speed";
    } elseif ($action == "sub-vip") {
        $code_dich_vu = "sub_vip";
    } elseif ($action == "sub-quality") {
        $code_dich_vu = "sub_quality";
    } elseif ($action == "cmt") {
        $code_dich_vu = "cmt";
    } elseif ($action == "cmt-sale") {
        $code_dich_vu = "cmt_sale";
    } elseif ($action == "like-page-sale") {
        $code_dich_vu = "like_page_sale";
    } elseif ($action == "like-page-speed") {
        $code_dich_vu = "like_page_speed";
    } elseif ($action == "like-page-quality") {
        $code_dich_vu = "like_page_quality";
    } elseif ($action == "share") {
        $code_dich_vu = "share";
    } elseif ($action == "share-sale") {
        $code_dich_vu = "share_sale";
    } elseif ($action == "mat-live") {
        $code_dich_vu = "mat_live";
    } elseif ($action == "view-video") {
        $code_dich_vu = "view_video";
    } elseif ($action == "like-cmt") {
        $code_dich_vu = "like_cmt";
    } elseif ($action == "view-story") {
        $code_dich_vu = "view_story";
    } else {
        $return['status'] = false;
        $return['error'] = true;
        $return['message'] = 'không tồn tại dịch vụ này !';
        die(json_encode($return));
    }
